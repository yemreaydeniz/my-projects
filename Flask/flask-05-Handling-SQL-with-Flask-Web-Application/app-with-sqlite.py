from flask import Flask, render_template, request  #render template template kiralar. 
from flask_sqlalchemy import SQLAlchemy  # sql ile ilgili kütüphaneleri indirir.
...
# GET ve POST kutucuğa değerler girdiğimizde kullanılıyor.
